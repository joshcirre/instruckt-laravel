/* instruckt v0.4.24 | MIT */
"use strict";var Instruckt=(()=>{var V=Object.defineProperty,at=Object.defineProperties,lt=Object.getOwnPropertyDescriptor,ct=Object.getOwnPropertyDescriptors,dt=Object.getOwnPropertyNames,q=Object.getOwnPropertySymbols;var Q=Object.prototype.hasOwnProperty,ye=Object.prototype.propertyIsEnumerable;var we=(t,e,n)=>e in t?V(t,e,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[e]=n,E=(t,e)=>{for(var n in e||(e={}))Q.call(e,n)&&we(t,n,e[n]);if(q)for(var n of q(e))ye.call(e,n)&&we(t,n,e[n]);return t},L=(t,e)=>at(t,ct(e));var ke=(t,e)=>{var n={};for(var o in t)Q.call(t,o)&&e.indexOf(o)<0&&(n[o]=t[o]);if(t!=null&&q)for(var o of q(t))e.indexOf(o)<0&&ye.call(t,o)&&(n[o]=t[o]);return n};var ut=(t,e)=>{for(var n in e)V(t,n,{get:e[n],enumerable:!0})},ht=(t,e,n,o)=>{if(e&&typeof e=="object"||typeof e=="function")for(let r of dt(e))!Q.call(t,r)&&r!==n&&V(t,r,{get:()=>e[r],enumerable:!(o=lt(e,r))||o.enumerable});return t};var pt=t=>ht(V({},"__esModule",{value:!0}),t);var to={};ut(to,{Instruckt:()=>H,init:()=>eo});function mt(){let t=document.cookie.match(/(?:^|;\s*)XSRF-TOKEN=([^;]+)/);return t?decodeURIComponent(t[1]):""}function ee(){let t={"Content-Type":"application/json",Accept:"application/json","X-Requested-With":"XMLHttpRequest"},e=mt();return e&&(t["X-XSRF-TOKEN"]=e),t}function R(t){let e={};for(let[n,o]of Object.entries(t)){let r=n.replace(/_([a-z])/g,(i,s)=>s.toUpperCase());e[r]=Array.isArray(o)?o.map(i=>i&&typeof i=="object"&&!Array.isArray(i)?R(i):i):o&&typeof o=="object"&&!Array.isArray(o)?R(o):o}return e}function te(t){let e={};for(let[n,o]of Object.entries(t)){let r=n.replace(/[A-Z]/g,i=>`_${i.toLowerCase()}`);e[r]=o&&typeof o=="object"&&!Array.isArray(o)?te(o):o}return e}var W=class{constructor(e){this.endpoint=e}async getAnnotations(){let e=await fetch(`${this.endpoint}/annotations`,{headers:ee()});if(!e.ok)throw new Error(`instruckt: failed to load annotations (${e.status})`);return(await e.json()).map(o=>R(o))}async addAnnotation(e){let n=await fetch(`${this.endpoint}/annotations`,{method:"POST",headers:ee(),body:JSON.stringify(te(e))});if(!n.ok)throw new Error(`instruckt: failed to add annotation (${n.status})`);return R(await n.json())}async updateAnnotation(e,n){let o=await fetch(`${this.endpoint}/annotations/${e}`,{method:"PATCH",headers:ee(),body:JSON.stringify(te(n))});if(!o.ok)throw new Error(`instruckt: failed to update annotation (${o.status})`);return R(await o.json())}};var ft=`
body.ik-annotating,
...
`:"",n=document.createElement("style");n.id="instruckt-global",n.textContent=e+ft+gt,document.head.appendChild(n)}var A={annotate:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z"/></svg>',freeze:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="4" height="16" rx="1"/><rect x="14" y="4" width="4" height="16" rx="1"/></svg>',copy:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>',check:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>',clear:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',minimize:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="7 13 12 18 17 13"/><line x1="12" y1="6" x2="12" y2="18"/></svg>',screenshot:'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>',logo:'<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4 12.5-12.5z"/></svg>'},$=class{constructor(e,n,o){this.position=e;this.callbacks=n;this.fabBadge=null;this.annotateActive=!1;this.freezeActive=!1;this.minimized=!1;this.totalCount=0;this.dragging=!1;this.dragOffset={x:0,y:0};this.keys=o!=null?o:{},this.build(),this.setupDrag()}build(){var l,u,h,f,g;this.host=document.createElement("div"),this.host.setAttribute("data-instruckt","toolbar"),this.shadow=this.host.attachShadow({mode:"open"});let e=document.createElement("style");e.textContent=xe,this.shadow.appendChild(e),this.toolbarEl=document.createElement("div"),this.toolbarEl.className="toolbar";let n=this.keys;this.annotateBtn=this.makeBtn(A.annotate,`Annotate elements (${((l=n.annotate)!=null?l:"A").toUpperCase()})`,()=>{let p=!this.annotateActive;this.setAnnotateActive(p),this.callbacks.onToggleAnnotate(p)}),this.freezeBtn=this.makeBtn(A.freeze,`Freeze page (${((u=n.freeze)!=null?u:"F").toUpperCase()})`,()=>{let p=!this.freezeActive;this.setFreezeActive(p),this.callbacks.onFreezeAnimations(p)});let o=this.makeBtn(A.screenshot,`Screenshot region (${((h=n.screenshot)!=null?h:"C").toUpperCase()})`,()=>{this.callbacks.onScreenshot()});this.copyBtn=this.makeBtn(A.copy,"Copy annotations as markdown",()=>{this.callbacks.onCopy(),this.copyBtn.innerHTML=A.check,setTimeout(()=>{this.copyBtn.innerHTML=A.copy},1200)});let r=document.createElement("div");r.className="clear-wrap";let i=this.makeBtn(A.clear,`Clear this page (${((f=n.clearPage)!=null?f:"X").toUpperCase()})`,()=>{var p,m;(m=(p=this.callbacks).onClearPage)==null||m.call(p)});i.classList.add("danger-btn");let s=this.makeBtn('<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></svg>',"Delete all instructions.",()=>{var p,m;return(m=(p=this.callbacks).onClearAll)==null?void 0:m.call(p)});s.classList.add("danger-btn","clear-all-btn"),r.appendChild(i),r.appendChild(s);let a=this.makeBtn(A.minimize,"Minimize toolbar",()=>{this.setMinimized(!0)});a.classList.add("minimize-btn");let c=()=>{let p=document.createElement("div");return p.className="divider",p};this.toolbarEl.append(this.annotateBtn,o,c(),this.freezeBtn,c(),this.copyBtn,r,c(),a),this.shadow.appendChild(this.toolbarEl),this.fab=document.createElement("button"),this.fab.className="fab",this.fab.title="Open instruckt toolbar",this.fab.setAttribute("aria-label","Open instruckt toolbar"),this.fab.innerHTML=A.logo,this.fab.style.display="none",this.fab.addEventListener("click",p=>{p.stopPropagation(),this.setMinimized(!1)}),this.shadow.appendChild(this.fab),this.host.addEventListener("click",p=>p.stopPropagation()),this.host.addEventListener("mousedown",p=>p.stopPropagation()),this.host.addEventListener("pointerdown",p=>p.stopPropagation()),this.applyPosition(),((g=document.getElementById("instruckt-root"))!=null?g:document.body).appendChild(this.host)}makeBtn(e,n,o){let r=document.createElement("button");return r.className="btn",r.setAttribute("data-tooltip",n),r.setAttribute("aria-label",n),r.innerHTML=e,r.addEventListener("click",i=>{i.stopPropagation(),o()}),r}applyPosition(){let e="16px";Object.assign(this.host.style,{position:"fixed",zIndex:"2147483646",bottom:this.position.includes("bottom")?e:"auto",top:this.position.includes("top")?e:"auto",right:this.position.includes("right")?e:"auto",left:this.position.includes("left")?e:"auto"})}setupDrag(){this.shadow.addEventListener("mousedown",e=>{let n=e;if(n.target.closest(".btn")||n.target.closest(".fab"))return;this.dragging=!0;let o=this.host.getBoundingClientRect();this.dragOffset={x:n.clientX-o.left,y:n.clientY-o.top},n.preventDefault()}),document.addEventListener("mousemove",e=>{this.dragging&&Object.assign(this.host.style,{left:`${e.clientX-this.dragOffset.x}px`,top:`${e.clientY-this.dragOffset.y}px`,right:"auto",bottom:"auto"})}),document.addEventListener("mouseup",()=>{this.dragging=!1})}setMinimized(e){var n,o;this.minimized=e,this.toolbarEl.style.display=e?"none":"",this.fab.style.display=e?"":"none",this.updateFabBadge(),(o=(n=this.callbacks).onMinimize)==null||o.call(n,e)}updateFabBadge(){var e;this.totalCount>0&&this.minimized?(this.fabBadge||(this.fabBadge=document.createElement("span"),this.fabBadge.className="fab-badge",this.fab.appendChild(this.fabBadge)),this.fabBadge.textContent=this.totalCount>99?"99+":String(this.totalCount)):((e=this.fabBadge)==null||e.remove(),this.fabBadge=null)}isMinimized(){return this.minimized}minimize(){this.minimized=!0,this.toolbarEl.style.display="none",this.fab.style.display="",this.updateFabBadge()}setAnnotateActive(e){this.annotateActive=e,this.annotateBtn.classList.toggle("active",e),document.body.classList.toggle("ik-annotating",e)}setFreezeActive(e){this.freezeActive=e,this.freezeBtn.classList.toggle("active",e)}setMode(e){this.setAnnotateActive(e==="annotating")}setAnnotationCount(e){let n=this.annotateBtn.querySelector(".badge");e>0?(n||(n=document.createElement("span"),n.className="badge",this.annotateBtn.appendChild(n)),n.textContent=e>99?"99+":String(e)):n==null||n.remove()}setTotalCount(e){this.totalCount=e,this.updateFabBadge()}destroy(){this.host.remove(),document.body.classList.remove("ik-annotating")}};var F=class{constructor(){var n;this.el=document.createElement("div"),Object.assign(this.el.style,{position:"fixed",pointerEvents:"none",zIndex:"2147483644",border:"2px solid rgba(99,102,241,0.7)",background:"rgba(99,102,241,0.1)",borderRadius:"3px",transition:"all 0.06s ease",display:"none"}),this.el.setAttribute("data-instruckt","highlight"),((n=document.getElementById("instruckt-root"))!=null?n:document.body).appendChild(this.el)}show(e){let n=e.getBoundingClientRect();if(n.width===0&&n.height===0){this.hide();return}Object.assign(this.el.style,{display:"block",left:`${n.left}px`,top:`${n.top}px`,width:`${n.width}px`,height:`${n.height}px`})}hide(){this.el.style.display="none"}destroy(){this.el.remove()}};function bt(t,e){return t[13]=1,t[14]=e>>8,t[15]=e&255,t[16]=e>>8,t[17]=e&255,t}var Le=112,Ie=72,ze=89,Be=115,re;function vt(){let t=new Int32Array(256);for(let e=0;e<256;e++){let n=e;for(let o=0;o<8;o++)n=n&1?3988292384^n>>>1:n>>>1;t[e]=n}return t}function wt(t){let e=-1;re||(re=vt());for(let n=0;n<t.length;n++)e=re[(e^t[n])&255]^e>>>8;return e^-1}function yt(t){let e=t.length-1;for(let n=e;n>=4;n--)if(t[n-4]===9&&t[n-3]===Le&&t[n-2]===Ie&&t[n-1]===ze&&t[n]===Be)return n-3;return 0}function kt(t,e,n=!1){let o=new Uint8Array(13);e*=39.3701,o[0]=Le,o[1]=Ie,o[2]=ze,o[3]=Be,o[4]=e>>>24,o[5]=e>>>16,o[6]=e>>>8,o[7]=e&255,o[8]=o[4],o[9]=o[5],o[10]=o[6],o[11]=o[7],o[12]=1;let r=wt(o),i=new Uint8Array(4);if(i[0]=r>>>24,i[1]=r>>>16,i[2]=r>>>8,i[3]=r&255,n){let s=yt(t);return t.set(o,s),t.set(i,s+13),t}else{let s=new Uint8Array(4);s[0]=0,s[1]=0,s[2]=0,s[3]=9;let a=new Uint8Array(54);return a.set(t,0),a.set(s,33),a.set(o,37),a.set(i,50),a}}var xt="AAlwSFlz",Et="AAAJcEhZ",St="AAAACXBI";function At(t){let e=t.indexOf(xt);return e===-1&&(e=t.indexOf(Et)),e===-1&&(e=t.indexOf(St)),e}var Re="[modern-screenshot]",C=typeof window!="undefined",Ct=C&&"Worker"in window,Tt=C&&"atob"in window,Pt=C&&"btoa"in window,Me,ae=C?(Me=window.navigator)==null?void 0:Me.userAgent:"",$e=ae.includes("Chrome"),K=ae.includes("AppleWebKit")&&!$e,le=ae.includes("Firefox"),Mt=t=>t&&"__CONTEXT__"in t,Lt=t=>t.constructor.name==="CSSFontFaceRule",It=t=>t.constructor.name==="CSSImportRule",zt=t=>t.constructor.name==="CSSLayerBlockRule",S=t=>t.nodeType===1,D=t=>typeof t.className=="object",Fe=t=>t.tagName==="image",Bt=t=>t.tagName==="use",N=t=>S(t)&&typeof t.style!="undefined"&&!D(t),Rt=t=>t.nodeType===8,$t=t=>t.nodeType===3,B=t=>t.tagName==="IMG",X=t=>t.tagName==="VIDEO",Ft=t=>t.tagName==="CANVAS",Nt=t=>t.tagName==="TEXTAREA",_t=t=>t.tagName==="INPUT",Ot=t=>t.tagName==="STYLE",Dt=t=>t.tagName==="SCRIPT",Ut=t=>t.tagName==="SELECT",jt=t=>t.tagName==="SLOT",Ht=t=>t.tagName==="IFRAME",qt=(...t)=>console.warn(Re,...t);function Vt(t){var n;let e=(n=t==null?void 0:t.createElement)==null?void 0:n.call(t,"canvas");return e&&(e.height=e.width=1),!!e&&"toDataURL"in e&&!!e.toDataURL("image/webp").includes("image/webp")}var ie=t=>t.startsWith("data:");function Ne(t,e){if(t.match(/^[a-z]+:\/\//i))return t;if(C&&t.match(/^\/\//))return window.location.protocol+t;if(t.match(/^[a-z]+:/i)||!C)return t;let n=Y().implementation.createHTMLDocument(),o=n.createElement("base"),r=n.createElement("a");return n.head.appendChild(o),n.body.appendChild(r),e&&(o.href=e),r.href=t,r.href}function Y(t){var e;return(e=t&&S(t)?t==null?void 0:t.ownerDocument:t)!=null?e:window.document}var J="http://www.w3.org/2000/svg";function Wt(t,e,n){let o=Y(n).createElementNS(J,"svg");return o.setAttributeNS(null,"width",t.toString()),o.setAttributeNS(null,"height",e.toString()),o.setAttributeNS(null,"viewBox",`0 0 ${t} ${e}`),o}function Kt(t,e){let n=new XMLSerializer().serializeToString(t);return e&&(n=n.replace(/[\u0000-\u0008\v\f\u000E-\u001F\uD800-\uDFFF\uFFFE\uFFFF]/gu,"")),`data:image/svg+xml;charset=utf-8,${encodeURIComponent(n)}`}function Xt(t,e){return new Promise((n,o)=>{let r=new FileReader;r.onload=()=>n(r.result),r.onerror=()=>o(r.error),r.onabort=()=>o(new Error(`Failed read blob to ${e}`)),e==="dataUrl"?r.readAsDataURL(t):e==="arrayBuffer"&&r.readAsArrayBuffer(t)})}var Yt=t=>Xt(t,"dataUrl");function z(t,e){let n=Y(e).createElement("img");return n.decoding="sync",n.loading="eager",n.src=t,n}function _(t,e){return new Promise(n=>{let{timeout:o,ownerDocument:r,onError:i,onWarn:s}=e!=null?e:{},a=typeof t=="string"?z(t,Y(r)):t,c=null,d=null;function l(){n(a),c&&clearTimeout(c),d==null||d()}if(o&&(c=setTimeout(l,o)),X(a)){let u=a.currentSrc||a.src;if(!u)return a.poster?_(a.poster,e).then(n):l();if(a.readyState>=2)return l();let h=l,f=g=>{s==null||s("Failed video load",u,g),i==null||i(g),l()};d=()=>{a.removeEventListener("loadeddata",h),a.removeEventListener("error",f)},a.addEventListener("loadeddata",h,{once:!0}),a.addEventListener("error",f,{once:!0})}else{let u=Fe(a)?a.href.baseVal:a.currentSrc||a.src;if(!u)return l();let h=async()=>{if(B(a)&&"decode"in a)try{await a.decode()}catch(g){s==null||s("Failed to decode image, trying to render anyway",a.dataset.originalSrc||u,g)}l()},f=g=>{s==null||s("Failed image load",a.dataset.originalSrc||u,g),l()};if(B(a)&&a.complete)return h();d=()=>{a.removeEventListener("load",h),a.removeEventListener("error",f)},a.addEventListener("load",h,{once:!0}),a.addEventListener("error",f,{once:!0})}})}async function Jt(t,e){N(t)&&(B(t)||X(t)?await _(t,e):await Promise.all(["img","video"].flatMap(n=>Array.from(t.querySelectorAll(n)).map(o=>_(o,e)))))}var _e=(function(){let e=0,n=()=>`0000${(Math.random()*36**4<<0).toString(36)}`.slice(-4);return()=>(e+=1,`u${n()}${e}`)})();function Oe(t){return t==null?void 0:t.split(",").map(e=>e.trim().replace(/"|'/g,"").toLowerCase()).filter(Boolean)}var Ee=0;function Gt(t){let e=`${Re}[#${Ee}]`;return Ee++,{time:n=>t&&console.time(`${e} ${n}`),timeEnd:n=>t&&console.timeEnd(`${e} ${n}`),warn:(...n)=>t&&qt(...n)}}function Zt(t){return{cache:t?"no-cache":"force-cache"}}async function G(t,e){return Mt(t)?t:Qt(t,L(E({},e),{autoDestruct:!0}))}async function Qt(t,e){var f,g,p,m,b;let{scale:n=1,workerUrl:o,workerNumber:r=1}=e||{},i=!!(e!=null&&e.debug),s=(f=e==null?void 0:e.features)!=null?f:!0,a=(g=t.ownerDocument)!=null?g:C?window.document:void 0,c=(m=(p=t.ownerDocument)==null?void 0:p.defaultView)!=null?m:C?window:void 0,d=new Map,l=L(E({width:0,height:0,quality:1,type:"image/png",scale:n,backgroundColor:null,style:null,filter:null,maximumCanvasSize:0,timeout:3e4,progress:null,debug:i,fetch:E({requestInit:Zt((b=e==null?void 0:e.fetch)==null?void 0:b.bypassingCache),placeholderImage:"data:image/png;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7",bypassingCache:!1},e==null?void 0:e.fetch),fetchFn:null,font:{},drawImageInterval:100,workerUrl:null,workerNumber:r,onCloneEachNode:null,onCloneNode:null,onEmbedNode:null,onCreateForeignObjectSvg:null,includeStyleProperties:null,autoDestruct:!1},e),{__CONTEXT__:!0,log:Gt(i),node:t,ownerDocument:a,ownerWindow:c,dpi:n===1?null:96*n,svgStyleElement:De(a),svgDefsElement:a==null?void 0:a.createElementNS(J,"defs"),svgStyles:new Map,defaultComputedStyles:new Map,workers:[...Array.from({length:Ct&&o&&r?r:0})].map(()=>{try{let w=new Worker(o);return w.onmessage=async v=>{var x,P,M,ve;let{url:y,result:k}=v.data;k?(P=(x=d.get(y))==null?void 0:x.resolve)==null||P.call(x,k):(ve=(M=d.get(y))==null?void 0:M.reject)==null||ve.call(M,new Error(`Error receiving message from worker: ${y}`))},w.onmessageerror=v=>{var k,x;let{url:y}=v.data;(x=(k=d.get(y))==null?void 0:k.reject)==null||x.call(k,new Error(`Error receiving message from worker: ${y}`))},w}catch(w){return l.log.warn("Failed to new Worker",w),null}}).filter(Boolean),fontFamilies:new Map,fontCssTexts:new Map,acceptOfImage:`${[Vt(a)&&"image/webp","image/svg+xml","image/*","*/*"].filter(Boolean).join(",")};q=0.8`,requests:d,drawImageCount:0,tasks:[],features:s,isEnable:w=>{var v,y;return w==="restoreScrollPosition"?typeof s=="boolean"?!1:(v=s[w])!=null?v:!1:typeof s=="boolean"?s:(y=s[w])!=null?y:!0},shadowRoots:[]});l.log.time("wait until load"),await Jt(t,{timeout:l.timeout,onWarn:l.log.warn}),l.log.timeEnd("wait until load");let{width:u,height:h}=en(t,l);return l.width=u,l.height=h,l}function De(t){if(!t)return;let e=t.createElement("style"),n=e.ownerDocument.createTextNode(`
.______background-clip--text {
  background-clip: text;
  -webkit-background-clip: text;
}
`);return e.appendChild(n),e}function en(t,e){let{width:n,height:o}=e;if(S(t)&&(!n||!o)){let r=t.getBoundingClientRect();n=n||r.width||Number(t.getAttribute("width"))||0,o=o||r.height||Number(t.getAttribute("height"))||0}return{width:n,height:o}}async function tn(t,e){let{log:n,timeout:o,drawImageCount:r,drawImageInterval:i}=e;n.time("image to canvas");let s=await _(t,{timeout:o,onWarn:e.log.warn}),{canvas:a,context2d:c}=nn(t.ownerDocument,e),d=()=>{try{c==null||c.drawImage(s,0,0,a.width,a.height)}catch(l){e.log.warn("Failed to drawImage",l)}};if(d(),e.isEnable("fixSvgXmlDecode"))for(let l=0;l<r;l++)await new Promise(u=>{setTimeout(()=>{c==null||c.clearRect(0,0,a.width,a.height),d(),u()},l+i)});return e.drawImageCount=0,n.timeEnd("image to canvas"),a}function nn(t,e){let{width:n,height:o,scale:r,backgroundColor:i,maximumCanvasSize:s}=e,a=t.createElement("canvas");a.width=Math.floor(n*r),a.height=Math.floor(o*r),a.style.width=`${n}px`,a.style.height=`${o}px`,s&&(a.width>s||a.height>s)&&(a.width>s&&a.height>s?a.width>a.height?(a.height*=s/a.width,a.width=s):(a.width*=s/a.height,a.height=s):a.width>s?(a.height*=s/a.width,a.width=s):(a.width*=s/a.height,a.height=s));let c=a.getContext("2d");return c&&i&&(c.fillStyle=i,c.fillRect(0,0,a.width,a.height)),{canvas:a,context2d:c}}function Ue(t,e){if(t.ownerDocument)try{let i=t.toDataURL();if(i!=="data:,")return z(i,t.ownerDocument)}catch(i){e.log.warn("Failed to clone canvas",i)}let n=t.cloneNode(!1),o=t.getContext("2d"),r=n.getContext("2d");try{return o&&r&&r.putImageData(o.getImageData(0,0,t.width,t.height),0,0),n}catch(i){e.log.warn("Failed to clone canvas",i)}return n}function on(t,e){var n;try{if((n=t==null?void 0:t.contentDocument)!=null&&n.body)return ce(t.contentDocument.body,e)}catch(o){e.log.warn("Failed to clone iframe",o)}return t.cloneNode(!1)}function rn(t){let e=t.cloneNode(!1);return t.currentSrc&&t.currentSrc!==t.src&&(e.src=t.currentSrc,e.srcset=""),e.loading==="lazy"&&(e.loading="eager"),e}async function sn(t,e){if(t.ownerDocument&&!t.currentSrc&&t.poster)return z(t.poster,t.ownerDocument);let n=t.cloneNode(!1);n.crossOrigin="anonymous",t.currentSrc&&t.currentSrc!==t.src&&(n.src=t.currentSrc);let o=n.ownerDocument;if(o){let r=!0;if(await _(n,{onError:()=>r=!1,onWarn:e.log.warn}),!r)return t.poster?z(t.poster,t.ownerDocument):n;n.currentTime=t.currentTime,await new Promise(s=>{n.addEventListener("seeked",s,{once:!0})});let i=o.createElement("canvas");i.width=t.offsetWidth,i.height=t.offsetHeight;try{let s=i.getContext("2d");s&&s.drawImage(n,0,0,i.width,i.height)}catch(s){return e.log.warn("Failed to clone video",s),t.poster?z(t.poster,t.ownerDocument):n}return Ue(i,e)}return n}function an(t,e){return Ft(t)?Ue(t,e):Ht(t)?on(t,e):B(t)?rn(t):X(t)?sn(t,e):t.cloneNode(!1)}function ln(t){let e=t.sandbox;if(!e){let{ownerDocument:n}=t;try{n&&(e=n.createElement("iframe"),e.id=`__SANDBOX__${_e()}`,e.width="0",e.height="0",e.style.visibility="hidden",e.style.position="fixed",n.body.appendChild(e),e.srcdoc='<!DOCTYPE html><meta charset="UTF-8"><title></title><body>',t.sandbox=e)}catch(o){t.log.warn("Failed to getSandBox",o)}}return e}var cn=["width","height","-webkit-text-fill-color"],dn=["stroke","fill"];function je(t,e,n){let{defaultComputedStyles:o}=n,r=t.nodeName.toLowerCase(),i=D(t)&&r!=="svg",s=i?dn.map(p=>[p,t.getAttribute(p)]).filter(([,p])=>p!==null):[],a=[i&&"svg",r,s.map((p,m)=>`${p}=${m}`).join(","),e].filter(Boolean).join(":");if(o.has(a))return o.get(a);let c=ln(n),d=c==null?void 0:c.contentWindow;if(!d)return new Map;let l=d==null?void 0:d.document,u,h;i?(u=l.createElementNS(J,"svg"),h=u.ownerDocument.createElementNS(u.namespaceURI,r),s.forEach(([p,m])=>{h.setAttributeNS(null,p,m)}),u.appendChild(h)):u=h=l.createElement(r),h.textContent=" ",l.body.appendChild(u);let f=d.getComputedStyle(h,e),g=new Map;for(let p=f.length,m=0;m<p;m++){let b=f.item(m);cn.includes(b)||g.set(b,f.getPropertyValue(b))}return l.body.removeChild(u),o.set(a,g),g}function He(t,e,n){var a;let o=new Map,r=[],i=new Map;if(n)for(let c of n)s(c);else for(let c=t.length,d=0;d<c;d++){let l=t.item(d);s(l)}for(let c=r.length,d=0;d<c;d++)(a=i.get(r[d]))==null||a.forEach((l,u)=>o.set(u,l));function s(c){let d=t.getPropertyValue(c),l=t.getPropertyPriority(c),u=c.lastIndexOf("-"),h=u>-1?c.substring(0,u):void 0;if(h){let f=i.get(h);f||(f=new Map,i.set(h,f)),f.set(c,[d,l])}e.get(c)===d&&!l||(h?r.push(h):o.set(c,[d,l]))}return o}function un(t,e,n,o){var u,h,f,g;let{ownerWindow:r,includeStyleProperties:i,currentParentNodeStyle:s}=o,a=e.style,c=r.getComputedStyle(t),d=je(t,null,o);s==null||s.forEach((p,m)=>{d.delete(m)});let l=He(c,d,i);l.delete("transition-property"),l.delete("all"),l.delete("d"),l.delete("content"),n&&(l.delete("margin-top"),l.delete("margin-right"),l.delete("margin-bottom"),l.delete("margin-left"),l.delete("margin-block-start"),l.delete("margin-block-end"),l.delete("margin-inline-start"),l.delete("margin-inline-end"),l.set("box-sizing",["border-box",""])),((u=l.get("background-clip"))==null?void 0:u[0])==="text"&&e.classList.add("______background-clip--text"),$e&&(l.has("font-kerning")||l.set("font-kerning",["normal",""]),(((h=l.get("overflow-x"))==null?void 0:h[0])==="hidden"||((f=l.get("overflow-y"))==null?void 0:f[0])==="hidden")&&((g=l.get("text-overflow"))==null?void 0:g[0])==="ellipsis"&&t.scrollWidth===t.clientWidth&&l.set("text-overflow",["clip",""]));for(let p=a.length,m=0;m<p;m++)a.removeProperty(a.item(m));return l.forEach(([p,m],b)=>{a.setProperty(b,p,m)}),l}function hn(t,e){(Nt(t)||_t(t)||Ut(t))&&e.setAttribute("value",t.value)}var pn=["::before","::after"],mn=["::-webkit-scrollbar","::-webkit-scrollbar-button","::-webkit-scrollbar-thumb","::-webkit-scrollbar-track","::-webkit-scrollbar-track-piece","::-webkit-scrollbar-corner","::-webkit-resizer"];function fn(t,e,n,o,r){let{ownerWindow:i,svgStyleElement:s,svgStyles:a,currentNodeStyle:c}=o;if(!s||!i)return;function d(l){var v;let u=i.getComputedStyle(t,l),h=u.getPropertyValue("content");if(!h||h==="none")return;r==null||r(h),h=h.replace(/(')|(")|(counter\(.+\))/g,"");let f=[_e()],g=je(t,l,o);c==null||c.forEach((y,k)=>{g.delete(k)});let p=He(u,g,o.includeStyleProperties);p.delete("content"),p.delete("-webkit-locale"),((v=p.get("background-clip"))==null?void 0:v[0])==="text"&&e.classList.add("______background-clip--text");let m=[`content: '${h}';`];if(p.forEach(([y,k],x)=>{m.push(`${x}: ${y}${k?" !important":""};`)}),m.length===1)return;try{e.className=[e.className,...f].join(" ")}catch(y){o.log.warn("Failed to copyPseudoClass",y);return}let b=m.join(`
  `),w=a.get(b);w||(w=[],a.set(b,w)),w.push(`.${f[0]}${l}`)}pn.forEach(d),n&&mn.forEach(d)}var Se=new Set(["symbol"]);async function Ae(t,e,n,o,r){if(S(n)&&(Ot(n)||Dt(n))||o.filter&&!o.filter(n))return;Se.has(e.nodeName)||Se.has(n.nodeName)?o.currentParentNodeStyle=void 0:o.currentParentNodeStyle=o.currentNodeStyle;let i=await ce(n,o,!1,r);o.isEnable("restoreScrollPosition")&&gn(t,i),e.appendChild(i)}async function Ce(t,e,n,o){var i;let r=t.firstChild;S(t)&&t.shadowRoot&&(r=(i=t.shadowRoot)==null?void 0:i.firstChild,n.shadowRoots.push(t.shadowRoot));for(let s=r;s;s=s.nextSibling)if(!Rt(s))if(S(s)&&jt(s)&&typeof s.assignedNodes=="function"){let a=s.assignedNodes();for(let c=0;c<a.length;c++)await Ae(t,e,a[c],n,o)}else await Ae(t,e,s,n,o)}function gn(t,e){if(!N(t)||!N(e))return;let{scrollTop:n,scrollLeft:o}=t;if(!n&&!o)return;let{transform:r}=e.style,i=new DOMMatrix(r),{a:s,b:a,c,d}=i;i.a=1,i.b=0,i.c=0,i.d=1,i.translateSelf(-o,-n),i.a=s,i.b=a,i.c=c,i.d=d,e.style.transform=i.toString()}function bn(t,e){let{backgroundColor:n,width:o,height:r,style:i}=e,s=t.style;if(n&&s.setProperty("background-color",n,"important"),o&&s.setProperty("width",`${o}px`,"important"),r&&s.setProperty("height",`${r}px`,"important"),i)for(let a in i)s[a]=i[a]}var vn=/^[\w-:]+$/;async function ce(t,e,n=!1,o){var d,l,u,h;let{ownerDocument:r,ownerWindow:i,fontFamilies:s,onCloneEachNode:a}=e;if(r&&$t(t))return o&&/\S/.test(t.data)&&o(t.data),r.createTextNode(t.data);if(r&&i&&S(t)&&(N(t)||D(t))){let f=await an(t,e);if(e.isEnable("removeAbnormalAttributes")){let v=f.getAttributeNames();for(let y=v.length,k=0;k<y;k++){let x=v[k];vn.test(x)||f.removeAttribute(x)}}let g=e.currentNodeStyle=un(t,f,n,e);n&&bn(f,e);let p=!1;if(e.isEnable("copyScrollbar")){let v=[(d=g.get("overflow-x"))==null?void 0:d[0],(l=g.get("overflow-y"))==null?void 0:l[0]];p=v.includes("scroll")||(v.includes("auto")||v.includes("overlay"))&&(t.scrollHeight>t.clientHeight||t.scrollWidth>t.clientWidth)}let m=(u=g.get("text-transform"))==null?void 0:u[0],b=Oe((h=g.get("font-family"))==null?void 0:h[0]),w=b?v=>{m==="uppercase"?v=v.toUpperCase():m==="lowercase"?v=v.toLowerCase():m==="capitalize"&&(v=v[0].toUpperCase()+v.substring(1)),b.forEach(y=>{let k=s.get(y);k||s.set(y,k=new Set),v.split("").forEach(x=>k.add(x))})}:void 0;return fn(t,f,p,e,w),hn(t,f),X(t)||await Ce(t,f,e,w),await(a==null?void 0:a(f)),f}let c=t.cloneNode(!1);return await Ce(t,c,e),await(a==null?void 0:a(c)),c}function wn(t){if(t.ownerDocument=void 0,t.ownerWindow=void 0,t.svgStyleElement=void 0,t.svgDefsElement=void 0,t.svgStyles.clear(),t.defaultComputedStyles.clear(),t.sandbox){try{t.sandbox.remove()}catch(e){t.log.warn("Failed to destroyContext",e)}t.sandbox=void 0}t.workers=[],t.fontFamilies.clear(),t.fontCssTexts.clear(),t.requests.clear(),t.tasks=[],t.shadowRoots=[]}function yn(t){let a=t,{url:e,timeout:n,responseType:o}=a,r=ke(a,["url","timeout","responseType"]),i=new AbortController,s=n?setTimeout(()=>i.abort(),n):void 0;return fetch(e,E({signal:i.signal},r)).then(c=>{if(!c.ok)throw new Error("Failed fetch, not 2xx response",{cause:c});switch(o){case"arrayBuffer":return c.arrayBuffer();case"dataUrl":return c.blob().then(Yt);default:return c.text()}}).finally(()=>clearTimeout(s))}function O(t,e){let{url:n,requestType:o="text",responseType:r="text",imageDom:i}=e,s=n,{timeout:a,acceptOfImage:c,requests:d,fetchFn:l,fetch:{requestInit:u,bypassingCache:h,placeholderImage:f},font:g,workers:p,fontFamilies:m}=t;o==="image"&&(K||le)&&t.drawImageCount++;let b=d.get(n);if(!b){h&&h instanceof RegExp&&h.test(s)&&(s+=(/\?/.test(s)?"&":"?")+new Date().getTime());let w=o.startsWith("font")&&g&&g.minify,v=new Set;w&&o.split(";")[1].split(",").forEach(P=>{m.has(P)&&m.get(P).forEach(M=>v.add(M))});let y=w&&v.size,k=E({url:s,timeout:a,responseType:y?"arrayBuffer":r,headers:o==="image"?{accept:c}:void 0},u);b={type:o,resolve:void 0,reject:void 0,response:null},b.response=(async()=>{if(l&&o==="image"){let x=await l(n);if(x)return x}return!K&&n.startsWith("http")&&p.length?new Promise((x,P)=>{p[d.size&p.length-1].postMessage(E({rawUrl:n},k)),b.resolve=x,b.reject=P}):yn(k)})().catch(x=>{if(d.delete(n),o==="image"&&f)return t.log.warn("Failed to fetch image base64, trying to use placeholder image",s),typeof f=="string"?f:f(i);throw x}),d.set(n,b)}return b.response}async function qe(t,e,n,o){if(!Ve(t))return t;for(let[r,i]of kn(t,e))try{let s=await O(n,{url:i,requestType:o?"image":"text",responseType:"dataUrl"});t=t.replace(xn(r),`$1${s}$3`)}catch(s){n.log.warn("Failed to fetch css data url",r,s)}return t}function Ve(t){return/url\((['"]?)([^'"]+?)\1\)/.test(t)}var We=/url\((['"]?)([^'"]+?)\1\)/g;function kn(t,e){let n=[];return t.replace(We,(o,r,i)=>(n.push([i,Ne(i,e)]),o)),n.filter(([o])=>!ie(o))}function xn(t){let e=t.replace(/([.*+?^${}()|\[\]\/\\])/g,"\\$1");return new RegExp(`(url\\(['"]?)(${e})(['"]?\\))`,"g")}var En=["background-image","border-image-source","-webkit-border-image","-webkit-mask-image","list-style-image"];function Sn(t,e){return En.map(n=>{let o=t.getPropertyValue(n);return!o||o==="none"?null:((K||le)&&e.drawImageCount++,qe(o,null,e,!0).then(r=>{!r||o===r||t.setProperty(n,r,t.getPropertyPriority(n))}))}).filter(Boolean)}function An(t,e){if(B(t)){let n=t.currentSrc||t.src;if(!ie(n))return[O(e,{url:n,imageDom:t,requestType:"image",responseType:"dataUrl"}).then(o=>{o&&(t.srcset="",t.dataset.originalSrc=n,t.src=o||"")})];(K||le)&&e.drawImageCount++}else if(D(t)&&!ie(t.href.baseVal)){let n=t.href.baseVal;return[O(e,{url:n,imageDom:t,requestType:"image",responseType:"dataUrl"}).then(o=>{o&&(t.dataset.originalSrc=n,t.href.baseVal=o||"")})]}return[]}function Cn(t,e){var a;let{ownerDocument:n,svgDefsElement:o}=e,r=(a=t.getAttribute("href"))!=null?a:t.getAttribute("xlink:href");if(!r)return[];let[i,s]=r.split("#");if(s){let c=`#${s}`,d=e.shadowRoots.reduce((l,u)=>l!=null?l:u.querySelector(`svg ${c}`),n==null?void 0:n.querySelector(`svg ${c}`));if(i&&t.setAttribute("href",c),o!=null&&o.querySelector(c))return[];if(d)return o==null||o.appendChild(d.cloneNode(!0)),[];if(i)return[O(e,{url:i,responseType:"text"}).then(l=>{o==null||o.insertAdjacentHTML("beforeend",l)})]}return[]}function Ke(t,e){let{tasks:n}=e;S(t)&&((B(t)||Fe(t))&&n.push(...An(t,e)),Bt(t)&&n.push(...Cn(t,e))),N(t)&&n.push(...Sn(t.style,e)),t.childNodes.forEach(o=>{Ke(o,e)})}async function Tn(t,e){let{ownerDocument:n,svgStyleElement:o,fontFamilies:r,fontCssTexts:i,tasks:s,font:a}=e;if(!(!n||!o||!r.size))if(a&&a.cssText){let c=Pe(a.cssText,e);o.appendChild(n.createTextNode(`${c}
`))}else{let c=Array.from(n.styleSheets).filter(l=>{try{return"cssRules"in l&&!!l.cssRules.length}catch(u){return e.log.warn(`Error while reading CSS rules from ${l.href}`,u),!1}});await Promise.all(c.flatMap(l=>Array.from(l.cssRules).map(async(u,h)=>{if(It(u)){let f=h+1,g=u.href,p="";try{p=await O(e,{url:g,requestType:"text",responseType:"text"})}catch(b){e.log.warn(`Error fetch remote css import from ${g}`,b)}let m=p.replace(We,(b,w,v)=>b.replace(v,Ne(v,g)));for(let b of Mn(m))try{l.insertRule(b,b.startsWith("@import")?f+=1:l.cssRules.length)}catch(w){e.log.warn("Error inserting rule from remote css import",{rule:b,error:w})}}})));let d=[];c.forEach(l=>{se(l.cssRules,d)}),d.filter(l=>{var u;return Lt(l)&&Ve(l.style.getPropertyValue("src"))&&((u=Oe(l.style.getPropertyValue("font-family")))==null?void 0:u.some(h=>r.has(h)))}).forEach(l=>{let u=l,h=i.get(u.cssText);h?o.appendChild(n.createTextNode(`${h}
`)):s.push(qe(u.cssText,u.parentStyleSheet?u.parentStyleSheet.href:null,e).then(f=>{f=Pe(f,e),i.set(u.cssText,f),o.appendChild(n.createTextNode(`${f}
`))}))})}}var Pn=/(\/\*[\s\S]*?\*\/)/g,Te=/((@.*?keyframes [\s\S]*?){([\s\S]*?}\s*?)})/gi;function Mn(t){if(t==null)return[];let e=[],n=t.replace(Pn,"");for(;;){let i=Te.exec(n);if(!i)break;e.push(i[0])}n=n.replace(Te,"");let o=/@import[\s\S]*?url\([^)]*\)[\s\S]*?;/gi,r=new RegExp("((\\s*?(?:\\/\\*[\\s\\S]*?\\*\\/)?\\s*?@media[\\s\\S]*?){([\\s\\S]*?)}\\s*?})|(([\\s\\S]*?){([\\s\\S]*?)})","gi");for(;;){let i=o.exec(n);if(i)r.lastIndex=o.lastIndex;else if(i=r.exec(n),i)o.lastIndex=r.lastIndex;else break;e.push(i[0])}return e}var Ln=/url\([^)]+\)\s*format\((["']?)([^"']+)\1\)/g,In=/src:\s*(?:url\([^)]+\)\s*format\([^)]+\)[,;]\s*)+/g;function Pe(t,e){let{font:n}=e,o=n?n==null?void 0:n.preferredFormat:void 0;return o?t.replace(In,r=>{for(;;){let[i,,s]=Ln.exec(r)||[];if(!s)return"";if(s===o)return`src: ${i};`}}):t}function se(t,e=[]){for(let n of Array.from(t))zt(n)?e.push(...se(n.cssRules)):"cssRules"in n?se(n.cssRules,e):e.push(n);return e}async function zn(t,e){let n=await G(t,e);if(S(n.node)&&D(n.node))return n.node;let{ownerDocument:o,log:r,tasks:i,svgStyleElement:s,svgDefsElement:a,svgStyles:c,font:d,progress:l,autoDestruct:u,onCloneNode:h,onEmbedNode:f,onCreateForeignObjectSvg:g}=n;r.time("clone node");let p=await ce(n.node,n,!0);if(s&&o){let y="";c.forEach((k,x)=>{y+=`${k.join(`,
`)} {
  ${x}
}
`}),s.appendChild(o.createTextNode(y))}r.timeEnd("clone node"),await(h==null?void 0:h(p)),d!==!1&&S(p)&&(r.time("embed web font"),await Tn(p,n),r.timeEnd("embed web font")),r.time("embed node"),Ke(p,n);let m=i.length,b=0,w=async()=>{for(;;){let y=i.pop();if(!y)break;try{await y}catch(k){n.log.warn("Failed to run task",k)}l==null||l(++b,m)}};l==null||l(b,m),await Promise.all([...Array.from({length:4})].map(w)),r.timeEnd("embed node"),await(f==null?void 0:f(p));let v=Bn(p,n);return a&&v.insertBefore(a,v.children[0]),s&&v.insertBefore(s,v.children[0]),u&&wn(n),await(g==null?void 0:g(v)),v}function Bn(t,e){let{width:n,height:o}=e,r=Wt(n,o,t.ownerDocument),i=r.ownerDocument.createElementNS(r.namespaceURI,"foreignObject");return i.setAttributeNS(null,"x","0%"),i.setAttributeNS(null,"y","0%"),i.setAttributeNS(null,"width","100%"),i.setAttributeNS(null,"height","100%"),i.append(t),r.appendChild(i),r}async function Rn(t,e){var s;let n=await G(t,e),o=await zn(n),r=Kt(o,n.isEnable("removeControlCharacter"));n.autoDestruct||(n.svgStyleElement=De(n.ownerDocument),n.svgDefsElement=(s=n.ownerDocument)==null?void 0:s.createElementNS(J,"defs"),n.svgStyles.clear());let i=z(r,o.ownerDocument);return await tn(i,n)}async function $n(t,e){let n=await G(t,e),{log:o,quality:r,type:i,dpi:s}=n,a=await Rn(n);o.time("canvas to data url");let c=a.toDataURL(i,r);if(["image/png","image/jpeg"].includes(i)&&s&&Tt&&Pt){let[d,l]=c.split(","),u=0,h=!1;if(i==="image/png"){let v=At(l);v>=0?(u=Math.ceil((v+28)/3)*4,h=!0):u=33/3*4}else i==="image/jpeg"&&(u=18/3*4);let f=l.substring(0,u),g=l.substring(u),p=window.atob(f),m=new Uint8Array(p.length);for(let v=0;v<m.length;v++)m[v]=p.charCodeAt(v);let b=i==="image/png"?kt(m,s,h):bt(m,s),w=window.btoa(String.fromCharCode(...b));c=[d,",",w,g].join("")}return o.timeEnd("canvas to data url"),c}async function de(t,e){return $n(await G(t,L(E({},e),{type:"image/png"})))}function Xe(t){var e;return!((e=t.getAttribute)!=null&&e.call(t,"data-instruckt"))}var I=null;async function Ye(){return I&&I.active||(I=await navigator.mediaDevices.getDisplayMedia({video:{displaySurface:"browser"},preferCurrentTab:!0}),I.getVideoTracks()[0].addEventListener("ended",()=>{I=null})),I}async function Fn(t){let e=document.createElement("video");e.srcObject=t,e.muted=!0,await e.play(),await new Promise(o=>requestAnimationFrame(()=>requestAnimationFrame(o)));let n=await createImageBitmap(e);return e.pause(),e.srcObject=null,n}function Je(t,e){return Fn(t).then(n=>{let o=window.devicePixelRatio||1,r=document.createElement("canvas");return r.width=e.width*o,r.height=e.height*o,r.getContext("2d").drawImage(n,e.x*o,e.y*o,e.width*o,e.height*o,0,0,r.width,r.height),n.close(),r.toDataURL("image/png")})}async function Ge(t){try{let e=await de(t,{scale:2,filter:Xe});if(e)return e}catch(e){}try{let e=await Ye();return await Je(e,t.getBoundingClientRect())}catch(e){return console.warn("[instruckt] captureElement failed:",e),null}}async function Ze(t){try{let e=await de(document.body,{scale:2,filter:Xe});if(e)return await Nn(e,t)}catch(e){}try{let e=await Ye();return await Je(e,t)}catch(e){return console.warn("[instruckt] captureRegion failed:",e),null}}function Nn(t,e){return new Promise((n,o)=>{let r=new Image;r.onload=()=>{let s=document.createElement("canvas");s.width=e.width*2,s.height=e.height*2,s.getContext("2d").drawImage(r,e.x*2,e.y*2,e.width*2,e.height*2,0,0,e.width*2,e.height*2),n(s.toDataURL("image/png"))},r.onerror=o,r.src=t})}function Qe(){return new Promise(t=>{let e=document.createElement("div");Object.assign(e.style,{position:"fixed",inset:"0",zIndex:"2147483647",cursor:"crosshair",background:"rgba(0,0,0,0.1)"}),e.setAttribute("data-instruckt","region-select");let n=document.createElement("div");Object.assign(n.style,{position:"fixed",border:"2px dashed #6366f1",background:"rgba(99,102,241,0.08)",borderRadius:"4px",display:"none",pointerEvents:"none"}),e.appendChild(n);let o=0,r=0,i=!1,s=h=>{o=h.clientX,r=h.clientY,i=!0,n.style.display="block",c(h)},a=h=>{i&&c(h)},c=h=>{let f=Math.min(o,h.clientX),g=Math.min(r,h.clientY),p=Math.abs(h.clientX-o),m=Math.abs(h.clientY-r);Object.assign(n.style,{left:`${f}px`,top:`${g}px`,width:`${p}px`,height:`${m}px`})},d=h=>{if(!i)return;i=!1;let f=Math.min(o,h.clientX),g=Math.min(r,h.clientY),p=Math.abs(h.clientX-o),m=Math.abs(h.clientY-r);u(),p<10||m<10?t(null):t(new DOMRect(f,g,p,m))},l=h=>{h.key==="Escape"&&(u(),t(null))},u=()=>{e.remove(),document.removeEventListener("keydown",l,!0)};e.addEventListener("mousedown",s),e.addEventListener("mousemove",a),e.addEventListener("mouseup",d),document.addEventListener("keydown",l,!0),document.body.appendChild(e)})}function _n(t,e){return t?t.startsWith("data:")?t:`${e!=null?e:"/instruckt"}/${t}`:null}function T(t){return String(t!=null?t:"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}var Z=class{constructor(){this.host=null;this.shadow=null;this.boundOutside=e=>{this.host&&!this.host.contains(e.target)&&this.destroy()}}showNew(e,n){var g,p;this.destroy(),this.host=document.createElement("div"),this.host.setAttribute("data-instruckt","popup"),this.stopHostPropagation(this.host),this.shadow=this.host.attachShadow({mode:"open"});let o=document.createElement("style");o.textContent=ne,this.shadow.appendChild(o);let r=document.createElement("div");r.className="popup";let i=e.framework?`<div class="fw-badge">${T(e.framework.component)}</div>`:"",s=e.selectedText?`<div class="selected-text">"${T(e.selectedText.slice(0,80))}"</div>`:"",a=!!e.screenshot;r.innerHTML=`
      <div class="header">
